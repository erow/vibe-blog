---
name: ui-ux-pro-max
description: Comprehensive UI/UX design guide for web and mobile apps. Use whenever the user wants to design, build, create, implement, review, fix, or improve a UI, screen, page, component, landing page, dashboard, color palette, typography, or chart. Provides a searchable database (67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines, 25 chart types) across 13 stacks with priority-based recommendations.
---
...
The search engine and its dataset live in the repo at `.shared/ui-ux-pro-max/` (shared across AI tools). Invoke the scripts with repo-root-relative paths as shown below (run from the repository root).
